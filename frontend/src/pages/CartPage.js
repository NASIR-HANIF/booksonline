    ...
    <Layout>
      <div className=" cart-page">
        ...
        <div className="container ">
          ...
          {
            cart?.map((p,i)=>(
              <div key={i} className=" cart mb-3 mt-2 d-md-block" >
              <div className="row g-0  d-flex flex-row  ">
                <div className="col-sm-4 ">
                  <img src={`/api/v1/product/product-photo/${p._id}`}
                    className="img-fluid  mx-auto" alt={p.name}
                    width="100%"
                ...
                <div className="col-sm-4 cart-remove-btn">
                <button
            ...
            <div className="col-md-5 cart-summary  m-5">
              <h2>Cart Summary</h2>
